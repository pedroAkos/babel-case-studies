...
public abstract class PaxosValue {
    ...
    public enum Type {
        APP_BATCH(0, AppOpBatch.serializer),
        NO_OP(1, NoOpValue.serializer);
    ...
    public static final ISerializer<PaxosValue> serializer = new ISerializer<PaxosValue>() {
