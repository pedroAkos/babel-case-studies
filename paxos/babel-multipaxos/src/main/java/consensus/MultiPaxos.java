...
public class MultiPaxos extends GenericProtocol {
    ...
    public static final String PROTOCOL_NAME = "SMultiNoPL";
    ...
    public MultiPaxos(Properties props) throws UnknownHostException {
    ...
    public void init(Properties props) throws HandlerRegistrationException, IOException {
        ...
        logger.info("MultiPaxos starting: " + peers + " " + quorumSize);
    }
    ...
    private void uponAcceptMsg(AcceptMsg msg, Host from, short sourceProto, int channel) {
        ...
        peers.forEach(m -> sendMessage(acceptedMsg, m));
        uponAcceptedMsg(acceptedMsg, self, this.getProtoId(), -1);
