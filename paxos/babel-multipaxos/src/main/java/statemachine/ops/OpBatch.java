...
public class OpBatch {
    ...
    public boolean equals(Object o) {
        ...
        return batchId == opBatch.batchId && Objects.equals(issuer, opBatch.issuer);
    }
    ...
    public static ISerializer<OpBatch> serializer = new ISerializer<OpBatch>() {
        @Override
