...
public class MyPaxosLogImpl implements MyPaxosLog {
	...
	/**
	 * The structure of each log
	 * @author luoyixin
	 *
	 */
	static class Log {
		// Type field 0 -> ballot, 1 -> AcceptBallot, 2 -> value
		int type;
		// length of value
		int len;
		// instance id
	...
	// Magic number, at the beginning of each log
	...
	/**
	 * Copy num to the specified position of the byte array
	 * @param data
	 * @param pos
	 * @param num
	 * @throws IOException
	...
	/**
	 * int to byte, in little-endian byte order
	 * @param num
	 * @return
	 */
	...
	/**
	 * byte to int, in little-endian byte order
	 * @param data
	 * @return
	 */
	...
	/**
	 * byte to int, in little-endian byte order, starting from the start position
	 * @param data
	 * @param start
	 * @return
	 */
