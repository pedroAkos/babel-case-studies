...
/**
 * A hodgepodge of various methods
 *
 */
public class MixAll {
    ...
    public static final void string2File(final String str, final String fileName) throws IOException {
        ...
        // Delete official documents
        File file = new File(fileName);
        file.delete();

        // Temporary documents changed to official documents
    ...
    /**
     * The string is converted to Properties. The format of the string is the same as the Properties configuration file.
     */
